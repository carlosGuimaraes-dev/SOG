...
Na versao `0.1.14`, o bootstrap suporta apenas Windows. O pacote baixa o
...
Asset padrao da versao do instalador `0.1.11`:

```text
SOG.Desktop.Setup.0.1.11.exe
```

## Publicacao

1. Publique o instalador Windows no R2 em `sog.carlosguimaraes.us/sogtj/v0.1.11/`.
...
```powershell
$env:ISOG_ASSET_URL="https://exemplo.local/SOG.Desktop.Setup.0.1.11.exe"
